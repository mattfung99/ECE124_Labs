...
if {[is_project_open]} {
	if {[string compare $quartus(project) "LogicalStep_Lab3"]} {
		puts "Project LogicalStep_Lab3 is not open"
		set make_assignments 0
	}
} else {
	# Only open if not already open
	if {[project_exists LogicalStep_Lab3]} {
		project_open -revision LogicalStep_Lab3_top LogicalStep_Lab3
	} else {
		project_new -revision LogicalStep_Lab3_top LogicalStep_Lab3
	}
...
if {$make_assignments} {
	...
	set_global_assignment -name SOURCE_FILE LogicalStep_Lab3_top.vhd
